...
export const biensMock: Bien[] = [
  {
    ...
    superficie: 80,
    nombrePieces: "3 chambres, 1 salle de bain, 1 salon",
    ...
    superficie: 120,
    nombrePieces: "2 chambres, 2 salles de bain, 1 salon",
    typeBien: "maison",
  },
   {
    id: 3,
    ...
    superficie: 300,
    nombrePieces: "4 chambres, 2 salles de bain, 1 salon, 1 piscine",
    typeBien: "maison",
  },
  {
     id: 4,
   ...
   },
    {
     ...
     superficie: 30,
     nombrePieces: "1 chambre, 1 salle de bain",
     typeBien: "studio",
    },
    {
     id: 6,
     ...
     superficie: 70,
     nombrePieces: "2 chambres, 1 salle de bain, 1 salon",
     typeBien: "maison",
    },
    {
     id: 7,
     ...
     superficie: 450,
     nombrePieces: "5 chambres, 2 salles de bain, 1 salon, 1 jardin",
     typeBien: "maison",
    },
    {
     id: 8,
...

   {
     ...
     superficie: 120,
     nombrePieces: "3 chambres, 2 salle de bain, 1 salon",
     typeBien: "maison",
   },
   ...
   },
   {
     ...
     superficie: 400,
     nombrePieces: "4 chambres, 2 salles de bain, 2 salons, 1 piscine",
     typeBien: "maison",
   },
   {
     id: 14,
...

   {
     ...
     superficie: 70,
     nombrePieces: "2 chambres, 1 salle de bain",
     typeBien: "appartement",
...

   {
     ...
     localisation: "Bastos, Yaounde",
     superficie: 74,
     nombrePieces: "3 chambres, 3 salles de bain, 1 salon",
     typeBien: "appartement",
   ...
   },
   {
     ...
     superficie: 200,
     nombrePieces: "5 chambres, 4 salles de bain, 2 cuisine",
     typeBien: "maison",
   },

   {
     ...
     localisation: "Eyang, Yaounde",
     superficie: 80,
     nombrePieces: "1 chambre, 1 salle de bain, 1 salon",
     typeBien: "appartement",
...

   {
     ...
     superficie: 600,
     nombrePieces: "4 chambres, 3 salles de bain, 1 salon, 1 piscine",
     typeBien: "maison",
   },
];